...
async function submitPublicForm(fields: Record<string, unknown>) {
  const res = await fetch(`${KLAR_BASE}/public/69d62a544c4bf986c6e1373a/69d62a28bb93020197f8c86d/submit`, {
    method: 'POST',
...
export default function PublicFormPersonal() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Personal — Formular</h1>
        </div>
